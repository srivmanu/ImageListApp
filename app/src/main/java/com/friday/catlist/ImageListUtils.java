...
public class ImageListUtils {
    ...
    public void getDummyList(int size, CatListFragment context) {
        String title = "DEMO";
    ...
    public void getListFromNetwork(String url, CatListFragment context) {
    ...
    private void parseJson(String json, CatListFragment context) {
